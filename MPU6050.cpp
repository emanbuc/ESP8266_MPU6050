...
ESP8266 Version by Emanuele Buchicchi
30 october 2016
...
bool MPU6050::beginCommon(mpu6050_dps_t scale, mpu6050_range_t range, int mpua){
    // Set Address
    mpuAddress = mpua;
...
bool MPU6050::beginSoftwareI2C(int sclpin, int sdapin, mpu6050_dps_t scale , mpu6050_range_t range, int mpua)
{
    Wire.begin(sdapin,sclpin);
    return beginCommon(scale,range,mpua);
}
